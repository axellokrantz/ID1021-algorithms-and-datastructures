...
public class ListQueue {
    ...
    public class Node{
        public TreeHeap.Node node;
        public Node next;

        public Node(TreeHeap.Node node){
            this.node = node;
            this.next = null;
        }
    }
    ...
    public void enqueue(TreeHeap.Node node){
    ...
    TreeHeap.Node dequeue() throws NullPointerException{ 

        TreeHeap.Node node = front.node;
